...
class InvitationTests: XCTestCase {
	...
	func testGenerateSealedInvitation() async throws {
		...
		let deserialized = try SealedInvitation(serializedBytes: try newInvitation.serializedData())
		...
		XCTAssertEqual(header.sender, alice.toV2().getPublicKeyBundle())
		XCTAssertEqual(header.recipient, bob.toV2().getPublicKeyBundle())
    ...
    func testGeneratesKnownDeterministicTopic() async throws {
        ...
        let aliceKeyData = ("0x0a8a030ac20108c192a3f7923112220a2068d2eb2ef8c50c4916b42ce638c5610e44ff4eb3ecb098" +
                                ...
                                "07d87bcc595510011a430a410422931e6295c3c93a5f6f5e729dc02e1754e916cb9be16d36dc163a" +
                                 "300931f42a0cd5fde957d75c2068e1980c5f86843daf16aba8ae57e8160b8b9f0191def09e").hexToData
        let aliceKeys = try PrivateKeyBundle(serializedBytes: aliceKeyData).v1.toV2()

        // address = 0x3De402A325323Bb97f00cE3ad5bFAc96A11F9A34
        let bobKeyData = ("0x0a88030ac001088cd68df7923112220a209057f8d813314a2aae74e6c4c30f909c1c496b6037ce32" +
                               ...
                               "907f3e9947719033e20edc9ca9665874bd88c64c6b62c01928065f6069c5c80c699924").hexToData
        let bobKeys = try PrivateKeyBundle(serializedBytes: bobKeyData)
